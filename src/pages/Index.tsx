          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="fade-in">
              ...
              <div className="space-y-4 text-lg">
                ...
                <p>
                  Художник Инга Савина создала авторскую интерпретацию космической темы, объединив героическую эстетику советской эпохи с архитектурой сталинского ампира.
                </p>
                <p>
