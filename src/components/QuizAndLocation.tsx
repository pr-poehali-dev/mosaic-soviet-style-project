...
const quizQuestions = [
  ...
  },
  {
    ...
    correct: 0,
    fact: 'При обратном наборе фрагменты собирают лицом вниз на бумагу в мастерской, потом переносят готовыми блоками на стену. Именно так работала Инга при создании мозаики «Канон» — это удобно для сложных деталей и точного соблюдения рисунка.',
  },
  {
